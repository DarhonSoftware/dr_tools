...
void CAbout::init()
{
  ...
  setAppName(QString("%1 %2 (Qt - %3)").arg("mobiFinance").arg(qApp->applicationVersion()).arg(QT_VERSION_STR));
  setCaption(tr("Manage your Personal Accounts"));
  setDescription(tr("mobiFinance is a simple to use and yet powerful software packed with all the necessary tools to control your accounts."));
