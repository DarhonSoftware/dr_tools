...
QString g_actCodeToAppCode(const QString &sActCode)
{
    ...
    //Evaluate AppCode
    QString sAppCode = QString("%1-%2-%3-%4")
                           .arg(u16Code1, 4, 16, QChar('0'))
                           .arg(u16Code2, 4, 16, QChar('0'))
                           .arg(u16Code3, 4, 16, QChar('0'))
                           .arg(u16Code4, 4, 16, QChar('0'));
...
QString g_appCodeToActCode(const QString &sAppCode)
{
    ...
    //Evaluate ActCode
    QString sActCode = QString("%1-%2-%3-%4")
                           .arg(u16Code1, 4, 16, QChar('0'))
                           .arg(u16Code2, 4, 16, QChar('0'))
                           .arg(u16Code3, 4, 16, QChar('0'))
                           .arg(u16Code4, 4, 16, QChar('0'));
